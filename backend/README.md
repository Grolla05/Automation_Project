...
## 4. Fluxograma de execução do sistema

       ___________________________
      | Algoritmo Automatização   |
      |___________________________|
                    |
         ...
         |_____________________|
          /         |         \
 ________|____   ___|_______   |______________
|Processamento| | Process.  |  | Carrega e en-|
|     PDF     | |  Excel    |  | via as ima.  |
...
## 👨‍💻 5. Guia do Desenvolvedor: Expansão do Sistema
...
## ⚙️ 6. Configurações Profissionais (`config_loader.py`)
...
## ❓ 7. Solução de Problemas Técnicos (Troubleshooting)
